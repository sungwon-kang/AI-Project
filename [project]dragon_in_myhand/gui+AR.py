...
class InMyHand(QMainWindow):
    ...
    def __init__(self):
        ...
        btn_composeButton = QPushButton('4. 이미지 합성', self)
        
        btn_guideButton = QPushButton('사용법', self)
        ...
        btn_guideButton.setGeometry(490, 10, 100, 30)
        ...
        layout_top.addWidget(btn_guideButton)
        ...
        btn_guideButton.clicked.connect(self.showGuideFunction)
